...
<p><a href="main2.jsp" mce_href="main2.jsp">ADD MORE</a> </p>

<table width="75%" border="1">
  <tr bgcolor="#CCCCCC">
    <td><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">BOOK TITLE</font></strong></td>
  ...
  <tr>
    ...
    <input type='text' name="quantity" value='<c:out value="${cartItem.quantity}"/>' size='2'> <input type="submit" name="action" value="Update">
...
<input type="image" src="tel-domain-buy-logo.jpg" name="buy" value="grand"></form>
</c:if>
