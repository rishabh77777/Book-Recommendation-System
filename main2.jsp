    ...
    <td width="972"><table width="723" height="88" border="0">
      <tr>
        ...
        <% if(session.getAttribute("uname")==null) {
			%>
           <a href="contact.jsp">Contact</a> | <a href="login.jsp">Login</a> | <a href="register.jsp">Signup</a>
            <%} else {
				%>
      ...
      <tr>
       ...
       <td> <form name="kmean" method="post" action="serv/K">
       <% String str=(String)session.getAttribute("uid");
     %>
       <input type="hidden" name="userid" value=<%=str %>>
      
<input type="submit" name="action" value="Users' Choice">
</form></td>
...
<%
		ps=con.prepareStatement("select * from books where year between 1971 and 1972 and publisher='Penguin Books'");
	//	 ps.setString(1,pid);
	int i=0;
		 rs=ps.executeQuery();
		 while(rs.next())
