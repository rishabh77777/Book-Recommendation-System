    ...
    <td width="972"><table width="723" height="88" border="0">
      <tr>
        ...
        <% if(session.getAttribute("uname")==null) {
			%>
           <a href="main2.jsp"> Home</a> | <a href="contact.jsp">Contact</a> | <a href="login.jsp">Login</a> | <a href="register.jsp">Signup</a>
            <%} else {
				%>
                <a href="main2.jsp"> Home</a> | <a href="contact.jsp">Contact</a> |<a href="logout.jsp">Logout</a>
                <%}%>
                </td>
      </tr>
      <tr>
   ...
   %>  
    ...
    <td><table width="550" height="84" border="0">
      <tr class="normal">
       ...
       <td height="60">CHECK THESE OUT:</td>
      </tr>
     <%// %> <tr>
...
<%
String isbn0,isbn1,isbn2,isbn3,isbn4,isbn5;
isbn0=getServletContext().getAttribute("isbn0").toString();
isbn1=getServletContext().getAttribute("isbn1").toString();
isbn2=getServletContext().getAttribute("isbn2").toString();
isbn3=getServletContext().getAttribute("isbn3").toString();
isbn4=getServletContext().getAttribute("isbn4").toString();
isbn5=getServletContext().getAttribute("isbn5").toString();

ps=con.prepareStatement("select * from books where ISBN like ? OR ISBN like ? OR ISBN like ? OR ISBN like ? OR ISBN like ? OR ISBN like ? ");
...
ps.setString(1,isbn0);
ps.setString(2,isbn1);
ps.setString(3,isbn2);
ps.setString(4,isbn3);
ps.setString(5,isbn4);
ps.setString(6,isbn5);
